...
import { Mail, Lock, Loader, Eye, EyeOff, Shield, ArrowLeft } from 'lucide-react';
      ...
      >
        ...
        <div className="glass rounded-3xl p-8 md:p-10 glow-blue relative overflow-hidden">
          ...
          >
            ...
            <p className="text-[#8899b8] text-sm">Sign in to access forensic tools</p>
          </motion.div>
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-4 mb-6">
            ...
            >
              <label className="block text-sm font-medium text-[#c8d4e8] mb-2">
                Email Address
              </label>
          ...
          >
            ...
            <Link href="/signup" className="text-[#0066ff] hover:text-[#00d4ff] font-semibold transition-colors">
              Create one
            </Link>
          </motion.div>
        </div>
